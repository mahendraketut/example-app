...
<head>
    ...
    <link rel="icon" href="{{ asset('sbadmin/img/schoolhelp.png') }}" type="image/png" sizes="16x16">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{asset('dashboard')}}">
                <div class="sidebar-brand-icon">
                    <img src="{{asset('sbadmin/img/schoolhelpwhite.png')}}" alt="Bunny.net" width="50" height="50">
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{asset('#')}}" data-toggle="collapse" data-target="#collapseUtilities"
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{asset('#')}}" data-toggle="collapse" data-target="#collapsePages"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; School HELP 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
